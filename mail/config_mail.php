...
$warning = '<div style = "width: 400px; margin: 0 auto; font-family: Verdana, Arial, Helvetica, sans-serif; border-radius: 9px; -moz-border-radius: 9px; background: #FFFFFF;padding-left:12px; padding-right:12px; border: 1px solid #DFDFDF; color: #000000; text-align:center"><h2 style = "font-size: 16px; color: #000000">Для отправки сообщения необходимо оформить заказ.</h2><p style = "font-size:14px"><a href = "javascript:history.back();">Вернуться назад</a></p></div>';
